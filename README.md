...
Используются три вспомогательных класса: 
...
3. В DBManager содержатся методы для взаимодействия с базой данных
...
2. Составляется список номеров, которые совершали вызовы
    ...
    * В таблице *MSISDN(ID INT PRIMARY KEY, NUMBER VARCHAR(15))* содержатся 25 номеров телефонов
